...
const RetailCaluclator = () => {
  ...
  const updateBillingDetails = (updatedCart) => {
    ...
    const grandTotal = cgstAmount+ sgstAmount +igstAmount+ discountedTotal ;
...
const generatePDFPage = (doc, copyType, invoiceNumber) => {
  ...
  const headerTable = [
    ...
    ['Address:1/400 North Street M Duraisamypuram', '',`Estimate Number: ${invoiceNumber}` ],
    ['Mamsapuram (po) ', '',`Date: ${selectedDate.getDate().toString().padStart(2, '0')}-${monthNames[selectedDate.getMonth()]}-${selectedDate.getFullYear()}` ],
